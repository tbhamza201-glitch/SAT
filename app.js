...
const translations = {
  ar: {
    // Nav
    home: 'الرئيسية', servers: 'الاشتراكات', verifications: 'التوثيقات', features: 'مميزاتنا',
    setup: 'التفعيل', faq: 'الأسئلة', contact: 'اتصل بنا',

    // Labels
    serversLabel: 'الباقات المتاحة',
    verificationsLabel: 'التوثيقات والضمانات',
    whyLabel:     'لماذا نحن؟',
    ...
    // Channels
    channelsTitle: 'أهم القنوات والباقات المتاحة'
  },

  fr: {
    home: 'Accueil', servers: 'Abonnements', verifications: 'Garanties', features: 'Avantages',
    setup: 'Installation', faq: 'FAQ', contact: 'Contact',

    serversLabel: 'Nos Offres',
    verificationsLabel: 'Garanties & Confiance',
    ...
    // Channels
    channelsTitle: 'Principales Chaînes et Bouquets'
  }
};
